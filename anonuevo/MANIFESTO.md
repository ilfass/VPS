...
Esto no es una demo técnica  
Esto no es un experimento de IA aislado  

👉 **Es una obra narrativa viva, que ocurre en tiempo real, deja memoria persistente y transforma a quien la narra.**
...
### 1. DEFINICIÓN DEL PROYECTO (VISIÓN GLOBAL)
#### 1.1 Qué es “El Viaje de ilfass”
“El Viaje de ilfass” es un viaje global serializado, narrado en primera persona, que ocurre en tiempo real y se documenta progresivamente en forma de un Libro Digital Vivo.
...
### 4. ACTO CERO — INTRODUCCIÓN DEL VIAJE
#### 4.1 El viaje NO empieza en un país
Empieza con una **INTRODUCCIÓN FUNDACIONAL**.

**Contenido obligatorio:**
*   Quién es ilfass
*   Qué es este viaje
*   Por qué se hace
*   Cómo se va a recorrer el mundo
*   Qué significa “en tiempo real”
*   Qué es el Libro Vivo
*   Qué se espera del espectador

#### 4.2 Forma de la introducción
*   Avatar visible (cara real)
*   Voz humana, pausada
*   Música ambiental sutil
*   Mapa global animado
*   Texto de manifiesto breve

Esta escena se **reutiliza**, funciona como “puerta de entrada” y sirve como descanso narrativo.

---

### 5. EL LIBRO DIGITAL VIVO (MEMORIA)
#### 5.1 Qué es el Libro
No es un blog. No es un archivo técnico. **Es la obra resultante del viaje.**
Funciona como: Memoria, Archivo, Documento cultural, Experiencia asincrónica.
...
*   Se cierra cuando el país termina

---

### 6. ARQUITECTURA WEB Y URLs (CANÓNICA)
#### 6.1 Presente (VIVOS)
*   `/`
*   `/vivos/mapa/`
*   `/vivos/portada/`
...
👉 El sistema debe moverse entre páginas automáticamente

---

### 7. ESCENOGRAFÍA Y TRANSICIONES
El stream transiciona entre páginas como si fueran cámaras:
*   Portada → identidad
*   Mapa → ubicación
*   País → profundidad
*   Diario → pulso
...
**Nada es estático. Todo es escena.**

---

### 8. PERSONAJE VISUAL (AVATAR)
#### 8.1 Identidad
El avatar **ES** la cara real del creador. No caricatura, no exageración, no máscara genérica.

#### 8.2 Estados
Idle, Narración, Observación, Reflexión.
El avatar aparece solo cuando suma y desaparece cuando el mapa o multimedia son protagonistas.

---

### 9. VOZ (CRÍTICO – ABSOLUTO)
La voz de ilfass:
❌ No robótica
❌ No sintética
❌ No plana
...
Se integran: Imágenes (IA + curadas), Videos, Sonidos ambientales, Música contextual, Silencio narrativo.
**Regla:** El multimedia acompaña, nunca invade.

---

### 11. DOBLE FUENTE DE CONTENIDO
#### 11.1 Contenido humano
Espacio donde el creador puede subir textos, imágenes, videos, sonidos, música.
El sistema debe poder buscar ahí e integrar eso al vivo y al libro.
...
### 12. INTERVENCIÓN HUMANA (DIRECCIÓN DE CÁMARAS)
El humano actúa como director de TV.
Puede: Cambiar escenas, Forzar cámara, Mostrar imagen puntual, Lanzar video, Activar reflexión, Ordenar silencio, Volver al mapa.
La automatización se pausa, se adapta y continúa luego.

---

### 13. ORQUESTACIÓN TÉCNICA
...
El **Orchestrator** coordina todo, evita superposiciones, garantiza continuidad y permite intervención humana.
